...
const SVG = memo(
  ({ fill = 'none', active, onEnd }: { fill?: string; active: boolean; onEnd?: () => void }) => {
    const ref = useRef<SVGSVGElement>(null);
    const [style, setStyle] = useTween({ opacity: fill === 'none' ? 1 : 0 });
      ...
      if (ref.current && active) {
        if (fill === 'none') {
          [
            ...
            ...ref.current.getElementsByTagName('line'),
            ...ref.current.getElementsByTagName('circle'),
          ].forEach((path) => {
    ...
    return (
      ...
      >
        <path
          id='Union_7'
          data-name='Union 7'
          d='M28.7,43.4c1.2,0,1.9,0.6,1.9,1.9c0,1.5-0.6,2.5-1.9,2.8l-15.2,4.6c-2.8,0-4.3-1.4-4.3-4.2c0-3,1.1-4.6,3.2-5
        ...
        c-0.3,0-0.5-0.2-0.7-0.6c-0.4-0.7-1.2-3.2-2.7-7.6c-0.1-0.4-0.2-0.6-0.2-0.9C71.4,25.9,71.8,25.5,72.7,25.5z'
          transform='translate(0.5 0.5)'
          stroke={fill === 'none' ? '#ea0029' : 'none'}
          fill={fill}
          strokeMiterlimit='10'
        ...
        />
        <path
          d='M416.6,15.3c1.9,0,2.8,0.8,2.8,2.4c0,1.1-0.4,2.2-1.2,3.2c-2.2,3.1-4.6,5.9-7.1,8.4c0.5,0.9,0.8,2,0.8,3.3
		...
		c0-1.8,1.2-2.7,3.5-2.7c2.6,0,3.9,1.2,3.9,3.5c0,4.2-0.1,8.8-0.3,13.9c9-2.8,16-5.5,21-8C456.9,32.1,457.5,31.9,458,31.9z'
          transform='translate(0.5 0.5)'
          stroke={fill === 'none' ? '#ea0029' : 'none'}
          fill={fill}
          strokeMiterlimit='10'
        ...
        />
        <path
          d='M26.5,383.2l5.2,0.8c20.9,0,34.9-0.3,42.2-0.8c1.2,0,1.9,0.8,1.9,2.5c0,1.2-0.5,2.3-1.6,3.3
		...
		C34,372,35.2,371.5,36.8,371.5z'
          transform='translate(0.5 0.5)'
          stroke={fill === 'none' ? '#ea0029' : 'none'}
          fill={fill}
          strokeMiterlimit='10'
        ...
        />
        <path
          d='M412.1,368.7l4.9,0.4l19.4,0.3c-0.1-2.8-0.2-5.7-0.3-8.8c0-2.1,1.2-3.2,3.5-3.2c2.8,0,4.3,1.3,4.3,3.9
		...
		c-1.5,0-2.2-0.6-2.2-1.7c0-0.3,1.3-2.7,3.9-7.1C455.2,358.6,456.3,358.1,457.8,358.1z'
          transform='translate(0.5 0.5)'
          stroke={fill === 'none' ? '#ea0029' : 'none'}
          fill={fill}
          strokeMiterlimit='10'
        ...
        />
        <path
          d='M162.5,155.5c1.7,0,3.1,0.2,4.2,0.5c0.9-0.5,1.8-0.8,2.6-0.9c4.4-0.9,10-1.4,16.7-1.4c3.3,0,6.4,0.3,9.4,0.9
		...
		C258.6,154.5,258,155.3,257.6,156z'
          transform='translate(0.5 0.5)'
          stroke={fill === 'none' ? '#ea0029' : 'none'}
          fill={fill}
          strokeMiterlimit='10'
        ...
        />
        <path
          d='M135.5,278.1c3.5,0.7,6.6,1.1,9.1,1.1l26.8-0.4c0-0.7,0-1.5-0.1-2.2c0-6,1.7-9.1,5.2-9.1
		...
		c5.1,0.1,10.6,0.4,16.3,1c0.7,0,1-0.4,1.1-1.1c0-2.6,0-4.8-0.1-6.7C193.2,316.3,187.4,316.4,182.3,316.5z'
          transform='translate(0.5 0.5)'
          stroke={fill === 'none' ? '#ea0029' : 'none'}
          fill={fill}
          strokeMiterlimit='10'
        ...
        />
        <path
          d='M302.7,276c8.7,0,19,0.2,30.7,0.6c9,0.3,16.7,0.4,22.9,0.4c4.8,0,8.7-0.1,11.7-0.4c2.6,0,3.9,1.3,3.9,3.9
		...
		C332.9,315.5,327.1,315.4,320.6,315.3z'
          transform='translate(0.5 0.5)'
          stroke={fill === 'none' ? '#ea0029' : 'none'}
          fill={fill}
          strokeMiterlimit='10'
